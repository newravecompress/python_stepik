...
после каждого ошибочного ввода нужно выводить значение строки error_message и при удачном вводе нужно 
вывести строку end_message и вернуть полученное целое число из функции (см. пример работы). 
...
def get_int(start_message, error_message, end_message):
    try:
        ...
        x = get_int(error_message, error_message, end_message)
    else:
        print(end_message)
    return x
