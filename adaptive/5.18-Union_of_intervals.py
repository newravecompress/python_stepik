...
если переданное значение попадает в множество объединённых интервалов {−10}∪(−5,3]∪(8,12)∪[16,+∞) 
...
if num == -10 or -5 < num <= 3 or 8 < num < 12 or num >= 16:
    print('True')
else:
    print('False')
...
# Еще проще:
print(num == -10 or -5 < num <= 3 or 8 < num < 12 or num >= 16)
